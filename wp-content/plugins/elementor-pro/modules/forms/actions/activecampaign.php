...
class Activecampaign extends Classes\Integration_Base {
	...
	public function run( $record, $ajax_handler ) {
		...
		if ( ! $subscriber ) {
			$ajax_handler->add_error_message( __( 'ActiveCampaign Integration requires an email field and a selected list', 'elementor-pro' ) );
			return;
		}
		...
		try {
			...
			$ajax_handler->add_error_message( 'ActiveCampaign ' . $exception->getMessage() );
		}
	}

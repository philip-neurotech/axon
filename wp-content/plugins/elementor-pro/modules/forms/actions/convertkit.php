...
class Convertkit extends Integration_Base {
	...
	public function run( $record, $ajax_handler ) {
		...
		if ( ! $subscriber ) {
			$ajax_handler->add_error_message( __( 'ConvertKit Integration requires an email field', 'elementor-pro' ) );
			return;
		}
		...
		try {
			...
			$ajax_handler->add_error_message( 'ConvertKit ' . $exception->getMessage() );
		}
	}
